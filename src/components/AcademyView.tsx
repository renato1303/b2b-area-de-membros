      ...
      {!selectedCourse ? (
        <div className="flex flex-col gap-2 mb-10">
          <span className="text-[10px] tracking-[0.3em] uppercase text-primary-accent font-mono font-bold">
            Área de Formação Comercial & Varejo
          </span>
          <h2 className="text-3xl font-extrabold tracking-tight text-primary-forest">
            Academia Será Cacau B2B
          </h2>
          <p className="text-xs text-secondary-text max-w-xl">
            Capacite sua equipe de atendentes, baristas e consultores com técnicas de degustação, storytelling do cacau fino de origem e visual merchandising para maximizar as vendas no balcão.
          </p>
        </div>
      ) : (
