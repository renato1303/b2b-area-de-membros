    ...
    <div className="px-6 md:px-12 py-8 max-w-7xl mx-auto w-full font-sans text-primary-text">
      ...
      {!selectedProduct ? (
        <div className="flex flex-col gap-6 mb-12">
          <div className="flex flex-col gap-2">
            <h2 className="text-3xl font-extrabold tracking-tight text-primary-forest flex items-center gap-3">
              ...
              <span>Catálogo & Mix Atacado</span>
            </h2>
            <p className="text-xs text-secondary-text max-w-xl">
              Acesso exclusivo à linha completa para revenda em empórios, cafeterias e lojas especializadas. Condições comerciais direto da fábrica com 30% de desconto para parceiros e revenda.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2 border-b border-border-color/60 pb-5">
            {[
              { id: 'todos', label: 'Todo Mix Atacado (10)' },
        ...
        >
          ...
          <span>Voltar ao Catálogo Atacado</span>
        </button>
      )}
      ...
      {!selectedProduct ? (
              ...
              <div className="pt-4 border-t border-border-color/60 flex justify-between items-center mt-4 font-mono">
                <div className="flex flex-col">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[9px] uppercase tracking-wider text-secondary-text/70">Revenda</span>
                  ...
                  <div className="flex items-baseline gap-2">
                    <span className="text-sm font-bold text-emerald-800">
                      {prod.wholesalePrice || prod.price}
                    </span>
                    <span className="text-[10px] text-secondary-text/60 line-through">
                ...
                <div className="flex items-center gap-2">
                  <a
                    ...
                    title="Pedir reposição direto da fábrica"
                  >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="bg-surface rounded-xl p-5 border border-border-color flex flex-col md:flex-row justify-between items-start md:items-center gap-6 shadow-sm">
              <div>
              ...
              {/* Price & Direct e-commerce purchase link */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 w-full md:w-auto justify-between md:justify-end">
                <div className="flex flex-col font-mono">
                  <div className="flex items-center gap-1.5">
                    <span className="text-[9px] uppercase tracking-wider text-secondary-text/70">Preço Revenda</span>
                    <span className="text-[8px] font-bold px-1.5 py-0.5 rounded bg-emerald-100 text-emerald-800 border border-emerald-200">
                      -30% OFF
                    </span>
                  </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full sm:w-auto flex items-center justify-center gap-2 px-6 py-3.5 bg-primary-forest hover:bg-primary-forest/90 text-white rounded-xl text-xs uppercase font-bold tracking-widest transition-all shadow-md hover:scale-102 font-mono cursor-pointer shrink-0"
                >
            ...
            <div className="flex border-b border-border-color/60 font-mono">
              {[
                { id: 'formula', label: 'Origem & Ingredientes' },
                { id: 'nutricional', label: 'Tabela Nutricional' },
                { id: 'prescricao', label: 'Argumentos de Venda & PDV' }
              ].map((tab) => (
                <button
            ...
            <div className="min-h-[220px]">
              ...
              {activeTab === 'formula' && (
                <div className="flex flex-col gap-6 animate-in fade-in duration-200">
                  <div className="flex flex-col gap-2.5">
                    <h4 className="text-xs uppercase tracking-widest font-bold text-primary-accent font-mono">Origem e Storytelling do Produto</h4>
                  ...
                  <div className="flex flex-col gap-3">
                    <h4 className="text-xs uppercase tracking-widest font-bold text-primary-accent font-mono">Ingredientes & Composição Limpa</h4>
                  ...
                  <div className="flex flex-col gap-3">
                    <h4 className="text-xs uppercase tracking-widest font-bold text-primary-accent font-mono">Diferenciais Competitivos no Balcão</h4>
                    ...
                    <div className="bg-emerald-500/10 rounded-xl p-4 border border-emerald-500/20 flex items-center justify-between shadow-sm">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <p className="text-[10px] text-emerald-700 leading-snug mt-0.5">Certificação livre de metais pesados, contaminações biológicas e micotoxinas para revenda com garantia.</p>
                        </div>
                      </div>
                      <a
                        id="download-laudo-btn"
                        href="/Ficha_Tecnica_Cacau_100_Organico.pdf"
                        download="Laudo_Tecnico_Sera_Cacau.pdf"
              ...
              {/* Tab: POS & Retail Sales Arguments */}
                ...
                <div className="flex flex-col gap-6 animate-in fade-in duration-200">
                  <div className="bg-primary-accent/15 p-5 rounded-xl border border-primary-accent/20 shadow-sm">
                    <span className="text-[9px] uppercase tracking-widest text-primary-accent font-bold font-mono">
                      Pitch de Venda no Balcão & Degustação
                    </span>
                    <p className="text-xs font-medium text-primary-forest leading-relaxed mt-2.5 italic">
                      {selectedProduct.protocol || 'Destaque ao cliente que este é um cacau 100% puro de agricultura sintrópica baiana, sem adição de açúcares, conservantes ou lecitina de soja. É a escolha definitiva para quem valoriza saúde metabólica e sabor nobre de terroir.'}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="bg-surface p-4.5 rounded-xl border border-border-color shadow-sm">
                      <h5 className="text-[10px] uppercase tracking-widest font-bold text-primary-accent font-mono">Perfil do Consumidor na Loja</h5>
                      <p className="text-xs text-secondary-text mt-1">Consumidores de alimentação limpa, low carb, apreciadores de cafés especiais e clientes em busca de presentes gourmets artesanais.</p>
                    </div>

                    <div className="bg-surface p-4.5 rounded-xl border border-border-color shadow-sm">
                      <h5 className="text-[10px] uppercase tracking-widest font-bold text-primary-accent font-mono">Estratégia de Degustação no PDV</h5>
                      <p className="text-xs text-secondary-text mt-1">Disponibilize pequenas lascas em taça de vidro próxima ao caixa ou prepare uma bebida morna de cortesia para elevar a conversão imediata.</p>
                    </div>
                  </div>
                </div>
              )}
