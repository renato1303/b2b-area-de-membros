        ...
        <div className="px-6 py-5 bg-[#FAF7F2] border-b border-[#2E4030]/10 flex items-center justify-between">
          <div>
            ...
            <h3 className="text-lg font-serif font-bold text-primary-forest mt-1">
              {editingMember ? `Editar: ${editingMember.name}` : 'Cadastrar Novo Lojista / Revendedor'}
            </h3>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1">
          ...
          <div>
            <label className="block text-[11px] font-mono font-bold uppercase tracking-wider text-[#526054] mb-1">
              Responsável Comercial / Loja <span className="text-rose-500">*</span>
            </label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="Ex: Carlos Mendes - Empório Grão Nobre"
          ...
          <div>
            <label className="block text-[11px] font-mono font-bold uppercase tracking-wider text-[#526054] mb-1">
              E-mail Comercial (Login) <span className="text-rose-500">*</span>
            </label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="Ex: compras@graonobre.com.br"
            ...
            <span className="text-[10px] text-[#6A786C] mt-1 block">
              O parceiro usará este e-mail para login e liberação automática de preços de atacado direto de fábrica.
            </span>
          </div>

          {/* Grid: Telefone e CNPJ */}
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-[11px] font-mono font-bold uppercase tracking-wider text-[#526054] mb-1">
                Telefone / WhatsApp de Compras
              </label>
              <div className="relative">
          ...
          <div>
            <label className="block text-[11px] font-mono font-bold uppercase tracking-wider text-[#526054] mb-1">
              Segmento / Tipo de Estabelecimento
            </label>
            <input
              type="text"
              value={specialty}
              onChange={e => setSpecialty(e.target.value)}
              placeholder="Ex: Empório Gourmet & Cafeteria de Especialidade"
          ...
          <div className="p-4 bg-[#FAF7F2] rounded-2xl border border-[#2E4030]/10 space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-[11px] font-mono font-bold uppercase tracking-wider text-primary-forest flex items-center gap-1.5">
                ...
                Cupom de Bonificação / Reposição B2B
              </label>
              <button
                type="button"
                onClick={() => {
            ...
            <p className="text-[10px] text-[#6A786C]">
              Código exclusivo do revendedor para bonificações de amostras e campanhas de sell-out no PDV.
            </p>
          </div>
          ...
          >
            {isLoading ? (
              ...
              <>
                ...
                <span>{editingMember ? 'Salvar Alterações' : 'Cadastrar Revendedor'}</span>
              </>
            )}
          </button>
        </div>
